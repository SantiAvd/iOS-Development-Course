...
//  TextFieldlearning
//
//  Created by Alexandr on 02.07.2024.
//
...
final class CustomTextField: UITextField {
    ...
    private func setupTextField(authTextFieldType: AuthTextFieldType) {
        ...
        case .name:
            attributedPlaceholder = NSAttributedString(string: authTextFieldType.placeholder, attributes: [NSAttributedString.Key.foregroundColor : #colorLiteral(red: 0.5843137503, green: 0.8235294223, blue: 0.4196078479, alpha: 1)])
